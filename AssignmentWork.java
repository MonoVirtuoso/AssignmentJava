...
public class AssignmentWork {
    ...
    public int verifyInput(int x, int y)
	{
        int usrInput = -1;
    ...
    public void Quiz() {
        ...
        System.out.println("Please enter 1 to start the quiz or enter 0 to return to the main menu:\n\n");
        
        int userAnswer = verifyInput(0,1);
